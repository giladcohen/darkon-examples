...
full_data_dir = '/data/dataset/cifar10/cifar-10-batches-py/data_batch_'
vali_dir = '/data/dataset/cifar10/cifar-10-batches-py/test_batch'
...
# added by zironycho
def read_validation_data_wo_whitening():
    '''
    Read in validation data. Whitening at the same time
    :return: Validation image data as 4D numpy array. Validation labels as 1D numpy array
    '''
